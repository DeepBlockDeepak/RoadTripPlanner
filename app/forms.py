...
class OriginDestinationForm(FlaskForm):
	origin_city_state = StringField(
		label='Origin: "City, State"', validators=[DataRequired()]
	)
	destination_city_state = StringField(
		label='Destination: "City, State"', validators=[DataRequired()]
	)
